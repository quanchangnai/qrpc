...
public class TransferableRegistry {
    ...
    private final Map<Integer, Supplier<Transferable>> id2Factories = new HashMap<>();

    private final Map<Class<? extends Transferable>, Integer> class2Ids = new HashMap<>();

    private final Map<Integer, Class<? extends Transferable>> id2Classes = new HashMap<>();
